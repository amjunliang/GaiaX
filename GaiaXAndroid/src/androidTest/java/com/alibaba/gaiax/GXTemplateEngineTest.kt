...
class GXTemplateEngineTest {
    ...
    fun template_aspect_ratio_height_to_width() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_aspect_ratio_height_to_width")
    ...
    fun template_aspect_ratio_width_to_height() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_aspect_ratio_width_to_height")
    ...
    fun template_max_size_width() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_max_size_width")
    ...
    fun template_max_size_height() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_max_size_height")
    ...
    fun template_min_size_width() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_min_size_width")
    ...
    fun template_min_size_height() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_min_size_height")
    ...
    fun template_normal_binary() {
        ...
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_normal_binary")
    ...
    fun template_text_fitcontent_case_1_lines_1_width_100pt_height_100px() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_fitcontent_case_1_lines_1_width_100pt_height_100px")
    ...
    fun template_text_fitcontent_case_1_lines_1_width_null_height_100px() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_fitcontent_case_1_lines_1_width_null_height_100px")
    ...
    fun template_text_fitcontent_case_1_lines_1_width_null_height_null() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_fitcontent_case_1_lines_1_width_null_height_null")
    ...
    fun template_text_fitcontent_lines_null_width_100pt_height_100px() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_fitcontent_case_1_lines_null_width_100pt_height_100px")
    ...
    fun template_text_fitcontent_case_1_lines_null_width_null_height_100px_repeat_bind_data() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_fitcontent_case_1_lines_null_width_null_height_100px_repeat_bind_data")
    ...
    fun template_text_fitcontent_case_2_lines_0_width_100pt_height_100px() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_fitcontent_case_2_lines_0_width_100pt_height_100px")
    ...
    fun template_text_fitcontent_case_2_lines_0_width_100px_height_100px() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_fitcontent_case_2_lines_0_width_100px_height_100px")
    ...
    fun template_text_fitcontent_case_2_lines_5_width_100pt_height_100px() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_fitcontent_case_2_lines_5_width_100pt_height_100px")
    ...
    fun template_text_text_process() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_text_process")
    ...
    fun template_text_fitcontent_case_1_lines_null_width_null_height_20px_lead_to_error_update_flexbox_size_minsize_maxsize() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_fitcontent_case_1_lines_null_width_null_height_20px_lead_to_error_update_flexbox_size_minsize_maxsize")
    ...
    fun template_view_property_display_none() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_view_property_display_none")
    ...
    fun template_view_property_display_flex() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_view_property_display_flex")
    ...
    fun template_view_property_hidden_true() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_view_property_hidden_true")
    ...
    fun template_view_property_hidden_false() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_view_property_hidden_false")
    ...
    fun template_view_property_display_hidden() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_view_property_display_hidden")
    ...
    fun template_view_property_opacity() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_view_property_opacity")
    ...
    fun template_view_property_overflow_visible() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_view_property_overflow_visible")
    ...
    fun template_view_property_overflow_hidden() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_view_property_overflow_hidden")
    ...
    fun template_view_property_background_color() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_view_property_background_color")
    ...
    fun template_view_property_background_image() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_view_property_background_image")
    ...
    fun template_text_property_padding() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_property_padding")
    ...
    fun template_text_property_padding_and_padding_bottom() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_property_padding_and_padding_bottom")
    ...
    fun template_text_property_font_size() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_property_font_size")
    ...
    fun template_text_property_font_family() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_property_font_family")
    ...
    fun template_text_property_font_weight() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_property_font_weight")
    ...
    fun template_text_property_font_color_default() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_property_font_color_default")
    ...
    fun template_text_property_font_color() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_property_font_color")
    ...
    fun template_text_property_text_overflow_clip() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_property_text_overflow_clip")
    ...
    fun template_text_property_text_overflow() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_property_text_overflow")
    ...
    fun template_text_property_text_overflow_ellipsis() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_property_text_overflow_ellipsis")
    ...
    fun template_text_property_text_decoration() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_property_text_decoration")
    ...
    fun template_text_property_text_decoration_line_through() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_property_text_decoration_line_through")
    ...
    fun template_text_property_text_decoration_underline() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_property_text_decoration_underline")
    ...
    fun template_text_property_line_height() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_property_line_height")
    ...
    fun template_text_property_line_height_same_size_height() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_text_property_line_height_same_size_height")
    ...
    fun template_image_property_mode() {
        InstrumentationRegistry.getInstrumentation().runOnMainSync {
            val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_image_property_mode")
            ...
            Assert.assertEquals(ImageView.ScaleType.FIT_XY, rootView.child<GXImageView>(0).scaleType)
        }
    }
    ...
    fun template_image_property_mode_scaleToFill() {
        InstrumentationRegistry.getInstrumentation().runOnMainSync {
            val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_image_property_mode_scaleToFill")
    ...
    fun template_image_property_mode_aspectFit() {
        InstrumentationRegistry.getInstrumentation().runOnMainSync {
            val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_image_property_mode_aspectFit")
    ...
    fun template_image_property_mode_aspectFill() {
        InstrumentationRegistry.getInstrumentation().runOnMainSync {
            val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_image_property_mode_aspectFill")
    ...
    fun template_image_property_mode_left_scale() {
        InstrumentationRegistry.getInstrumentation().runOnMainSync {
            val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_image_property_mode_left_scale")
    ...
    fun template_image_property_mode_left_crop() {
        InstrumentationRegistry.getInstrumentation().runOnMainSync {
            ...
            val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_image_property_mode_left_crop")
    ...
    @Test
    fun template_shadow() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_shadow")
    ...
    fun template_event_tap_listener() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_event_tap_listener")
    ...
    fun template_event_tap_listener_display_none() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_event_tap_listener_display_none")
    ...
    fun template_event_tap_listener_hidden_true() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_event_tap_listener_hidden_true")
    ...
    fun template_event_longpress_listener() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_event_longpress_listener")
    ...
    fun template_event_track_listener() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_event_track_listener")
    ...
    fun template_event_track_listener_display_none() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_event_track_listener_display_none")
    ...
    fun template_event_track_listener_hidden_true() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_event_track_listener_hidden_true")
...
//        }
    ...
    fun template_richtext_property_font_color_default() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_richtext_property_font_color_default")
    ...
    fun template_richtext_property_font_color() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_richtext_property_font_color")
    ...
    fun template_iconfont_property_font_color() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_iconfont_property_font_color")
    ...
    fun template_iconfont_property_font_color_default() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_iconfont_property_font_color_default")
    ...
    fun template_iconfont_property_font_family_null() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_iconfont_property_font_family_null")
    ...
    fun template_scroll_css_extend_modify_item() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_scroll_css_extend_modify_item")
    ...
    fun template_scroll_child_count() {
        ...
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_scroll_child_count")
    ...
    fun template_scroll_multi_type_item_one() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_scroll_multi_type_item_one")
    ...
    fun template_scroll_width_auto() {
        ...
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_scroll_width_auto")
    ...
    fun template_scroll_vertical_height_auto() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_scroll_vertical_height_auto")
    ...
    fun template_scroll_item_spacing() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_scroll_item_spacing")
    ...
    fun template_scroll_edge_item_spacing() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_scroll_edge_item_spacing")
    ...
    fun template_scroll_modify_item() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_scroll_modify_item")
    ...
    fun template_scroll_height_auto() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_scroll_height_auto")
    ...
    fun template_scroll_height_percent_100_limit_height() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_scroll_height_percent_100")
    ...
    fun template_scroll_height_fixed() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_scroll_height_fixed")
    ...
    fun template_grid_height_100pt_scroll_enable_true() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_grid_height_100pt_scroll_enable_true")
        ...
        val rootView = GXTemplateEngine.instance.createView(templateItem, GXTemplateEngine.GXMeasureSize(MOCK_SCREEN_WIDTH, 200F.dpToPx()))
        GXTemplateEngine.instance.bindData(rootView, templateData)
        ...
        Assert.assertEquals(false, (rootView as? GXGridView)?.layoutManager?.canScrollHorizontally())
    }

    @Test
    fun template_grid_height_flow() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_grid_height_flow")
        ...
        Assert.assertEquals(true, (rootView.child(1) as? GXGridView)?.layoutManager?.canScrollVertically())
        Assert.assertEquals(false, (rootView.child(1) as? GXGridView)?.layoutManager?.canScrollHorizontally())
    }

    @Test
    fun template_grid_height_100px_scroll_enable_true() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_grid_height_100px_scroll_enable_true")
    ...
    fun template_grid_normal() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_grid_normal")
    ...
    fun template_grid_extend_column() {
        ...
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_grid_extend_column")
    ...
    fun template_grid_height_100px() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_grid_height_100px")
    ...
    fun template_grid_height_auto() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_grid_height_auto")
    ...
    fun template_grid_item_spacing_raw_spacing() {
        ...
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_grid_item_spacing_raw_spacing")
    ...
    fun template_grid_item_spacing_raw_spacing_edge() {
        ...
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_grid_item_spacing_raw_spacing_edge")
    ...
    fun template_grid_item_spacing_raw_spacing_edge_column_3() {
        ...
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_grid_item_spacing_raw_spacing_edge_column_3")
    ...
    @Test
    fun template_nest() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_nest")
    ...
    fun template_nest_child_databinding_update_property_height() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_nest_child_databinding_update_property_height")
    ...
    fun template_nest_parent_databinding_update_property_height_and_child_databinding_update_property_width() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_nest_parent_databinding_update_property_height_and_child_databinding_update_property_width")
    ...
    fun template_nest_parent_databinding_update_property_height_and_child_databinding_update_property_height() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_nest_parent_databinding_update_property_height_and_child_databinding_update_property_height")
    ...
    fun template_nest_databinding_override_width_height() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_nest_databinding_override_width_height")
    ...
    fun template_nest_databinding_override_both() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_nest_databinding_override_both")
    ...
    fun template_nest_databinding_override_only_child() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_nest_databinding_override_only_child")
    ...
    fun template_nest_databinding_override_only_child_value() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_nest_databinding_override_only_child_value")
    ...
    fun template_nest_databinding_override_both_value() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_nest_databinding_override_both_value")
    ...
    fun template_nest_scroll_self_nodes() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_nest_scroll_self_nodes")
    ...
    fun template_nest_css_override_width_height() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_nest_css_override_width_height")
    ...
    fun template_merge_empty_nodes() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_merge_empty_nodes")
    ...
    fun template_merge_empty_nodes_exclude_container_type() {
        val templateItem = GXTemplateEngine.GXTemplateItem(GXMockUtils.context, "integration", "template_merge_empty_nodes_exclude_container_type")
